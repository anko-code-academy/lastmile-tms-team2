...
namespace LastMile.TMS.Persistence.Migrations
{
    ...
    [Migration("20260412214401_AddRouteParcelAdjustments")]
    partial class AddRouteParcelAdjustments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.Route", b =>
                {
                    ...
                    b.Property<int>("PlannedDistanceMeters")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<LineString>("PlannedPath")
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.RouteParcelAdjustmentAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("AffectedStopSequence")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("RouteParcelAdjustmentAuditEntries", (string)null);
                });
            ...
            modelBuilder.Entity("RouteStopParcels", b =>
                {
                    b.Property<Guid>("ParcelsId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ParcelsId", "RouteStopId");

                    b.HasIndex("RouteStopId");

                    b.ToTable("RouteStopParcels");
                });
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.RouteParcelAdjustmentAuditEntry", b =>
                {
                    b.HasOne("LastMile.TMS.Domain.Entities.Route", "Route")
                        .WithMany("ParcelAdjustmentAuditTrail")
                        .HasForeignKey("RouteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RouteStopParcels", b =>
                {
                    ...
                    b.HasOne("LastMile.TMS.Domain.Entities.RouteStop", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.Route", b =>
                {
                    ...
                    b.Navigation("ParcelAdjustmentAuditTrail");
