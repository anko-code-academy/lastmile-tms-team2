...
export type AdjustRouteParcelInput = {
...
export type DepotParcelAgingAlert = {
  __typename?: 'DepotParcelAgingAlert';
  count: Scalars['Int']['output'];
  thresholdMinutes: Scalars['Int']['output'];
};

export type DepotParcelInventoryDashboard = {
  __typename?: 'DepotParcelInventoryDashboard';
  agingAlert: DepotParcelAgingAlert;
  depotId: Scalars['UUID']['output'];
  depotName: Scalars['String']['output'];
  generatedAt: Scalars['DateTime']['output'];
  statusCounts: Array<DepotParcelInventoryStatusCount>;
  zoneCounts: Array<DepotParcelInventoryZoneCount>;
};

export type DepotParcelInventoryPageInfo = {
  __typename?: 'DepotParcelInventoryPageInfo';
...
export type DepotParcelInventoryParcel = {
  __typename?: 'DepotParcelInventoryParcel';
  ageMinutes: Scalars['Int']['output'];
  id: Scalars['UUID']['output'];
...
export type DepotParcelInventoryParcelConnection = {
  __typename?: 'DepotParcelInventoryParcelConnection';
  nodes: Array<DepotParcelInventoryParcel>;
  pageInfo: DepotParcelInventoryPageInfo;
  totalCount: Scalars['Int']['output'];
};

export type DepotParcelInventoryStatusCount = {
  __typename?: 'DepotParcelInventoryStatusCount';
  count: Scalars['Int']['output'];
  status: Scalars['String']['output'];
};

export type DepotParcelInventoryZoneCount = {
  __typename?: 'DepotParcelInventoryZoneCount';
  count: Scalars['Int']['output'];
  zoneId: Scalars['UUID']['output'];
  zoneName: Scalars['String']['output'];
};
...
export type Mutation = {
  __typename?: 'Mutation';
  addParcelToDispatchedRoute?: Maybe<Route>;
  ...
  removeParcelFromDispatchedRoute?: Maybe<Route>;
...
export type MutationAddParcelToDispatchedRouteArgs = {
  id: Scalars['UUID']['input'];
  input: AdjustRouteParcelInput;
};
...
export type MutationRemoveParcelFromDispatchedRouteArgs = {
  id: Scalars['UUID']['input'];
  input: AdjustRouteParcelInput;
};
...
export type Query = {
  __typename?: 'Query';
  depot?: Maybe<Depot>;
  depotParcelInventory?: Maybe<DepotParcelInventoryDashboard>;
  depotParcelInventoryParcels: DepotParcelInventoryParcelConnection;
  depotStorageLayout?: Maybe<DepotStorageLayout>;
  depots: Array<Depot>;
  dispatchedRouteParcelCandidates: Array<RouteParcelAdjustmentCandidate>;
  driver?: Maybe<Driver>;
...
export type QueryDepotParcelInventoryArgs = {
  agingThresholdMinutes: Scalars['Int']['input'];
};


export type QueryDepotParcelInventoryParcelsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  agingOnly: Scalars['Boolean']['input'];
  agingThresholdMinutes: Scalars['Int']['input'];
...
export type QueryDispatchedRouteParcelCandidatesArgs = {
  routeId: Scalars['UUID']['input'];
};
...
export type Route = {
  ...
  id: Scalars['UUID']['output'];
  latestParcelAdjustment?: Maybe<RouteParcelAdjustmentAuditEntry>;
  parcelAdjustmentAuditTrail: Array<RouteParcelAdjustmentAuditEntry>;
...
export type RouteParcelAdjustmentAction =
  | 'ADDED'
  | 'REMOVED';

export type RouteParcelAdjustmentAuditEntry = {
  __typename?: 'RouteParcelAdjustmentAuditEntry';
  action: RouteParcelAdjustmentAction;
  affectedStopSequence?: Maybe<Scalars['Int']['output']>;
  changedAt: Scalars['DateTime']['output'];
  changedBy?: Maybe<Scalars['String']['output']>;
  id: Scalars['UUID']['output'];
  parcelId: Scalars['UUID']['output'];
...
export type RouteParcelAdjustmentCandidate = {
  __typename?: 'RouteParcelAdjustmentCandidate';
...
export type GetDepotParcelInventoryQueryVariables = Exact<{
  agingThresholdMinutes: Scalars['Int']['input'];
}>;


export type GetDepotParcelInventoryQuery = { __typename?: 'Query', depotParcelInventory?: { __typename?: 'DepotParcelInventoryDashboard', depotId: string, depotName: string, generatedAt: string, statusCounts: Array<{ __typename?: 'DepotParcelInventoryStatusCount', status: string, count: number }>, zoneCounts: Array<{ __typename?: 'DepotParcelInventoryZoneCount', zoneId: string, zoneName: string, count: number }>, agingAlert: { __typename?: 'DepotParcelAgingAlert', thresholdMinutes: number, count: number } } | null };

export type GetDepotParcelInventoryParcelsQueryVariables = Exact<{
  agingThresholdMinutes: Scalars['Int']['input'];
  status?: InputMaybe<ParcelStatus>;
  zoneId?: InputMaybe<Scalars['UUID']['input']>;
  agingOnly: Scalars['Boolean']['input'];
...
export type GetDepotParcelInventoryParcelsQuery = { __typename?: 'Query', depotParcelInventoryParcels: { __typename?: 'DepotParcelInventoryParcelConnection', totalCount: number, pageInfo: { __typename?: 'DepotParcelInventoryPageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, nodes: Array<{ __typename?: 'DepotParcelInventoryParcel', id: string, trackingNumber: string, status: string, zoneId: string, zoneName: string, ageMinutes: number, lastUpdatedAt: string }> } };
...
export type GetRoutesMapQuery = { __typename?: 'Query', routes: Array<{ __typename?: 'Route', depotId: string, depotName?: string | null, depotAddressLine?: string | null, depotLongitude?: number | null, depotLatitude?: number | null, id: string, zoneId: string, zoneName?: string | null, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, dispatchedAt?: string | null, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, estimatedStopCount: number, plannedDistanceMeters: number, plannedDurationSeconds: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null, path: Array<{ __typename?: 'RoutePathPoint', longitude: number, latitude: number }>, stops: Array<{ __typename?: 'RouteStop', id: string, sequence: number, recipientLabel: string, addressLine: string, longitude: number, latitude: number, parcels: Array<{ __typename?: 'RouteStopParcelDto', parcelId: string, trackingNumber: string, recipientLabel: string, addressLine: string, status: ParcelStatus }> }>, latestParcelAdjustment?: { __typename?: 'RouteParcelAdjustmentAuditEntry', id: string, action: RouteParcelAdjustmentAction, parcelId: string, trackingNumber: string, reason: string, affectedStopSequence?: number | null, changedAt: string, changedBy?: string | null } | null }> };
...
export type GetRouteQuery = { __typename?: 'Query', route?: { __typename?: 'Route', depotId: string, depotName?: string | null, depotAddressLine?: string | null, depotLongitude?: number | null, depotLatitude?: number | null, id: string, zoneId: string, zoneName?: string | null, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, dispatchedAt?: string | null, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, estimatedStopCount: number, plannedDistanceMeters: number, plannedDurationSeconds: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null, path: Array<{ __typename?: 'RoutePathPoint', longitude: number, latitude: number }>, stops: Array<{ __typename?: 'RouteStop', id: string, sequence: number, recipientLabel: string, addressLine: string, longitude: number, latitude: number, parcels: Array<{ __typename?: 'RouteStopParcelDto', parcelId: string, trackingNumber: string, recipientLabel: string, addressLine: string, status: ParcelStatus }> }>, assignmentAuditTrail: Array<{ __typename?: 'RouteAssignmentAuditEntry', id: string, action: RouteAssignmentAuditAction, previousDriverId?: string | null, previousDriverName?: string | null, newDriverId: string, newDriverName: string, previousVehicleId?: string | null, previousVehiclePlate?: string | null, newVehicleId: string, newVehiclePlate: string, changedAt: string, changedBy?: string | null }>, parcelAdjustmentAuditTrail: Array<{ __typename?: 'RouteParcelAdjustmentAuditEntry', id: string, action: RouteParcelAdjustmentAction, parcelId: string, trackingNumber: string, reason: string, affectedStopSequence?: number | null, changedAt: string, changedBy?: string | null }>, latestParcelAdjustment?: { __typename?: 'RouteParcelAdjustmentAuditEntry', id: string, action: RouteParcelAdjustmentAction, parcelId: string, trackingNumber: string, reason: string, affectedStopSequence?: number | null, changedAt: string, changedBy?: string | null } | null } | null };
...
export type GetDispatchedRouteParcelCandidatesQueryVariables = Exact<{
  routeId: Scalars['UUID']['input'];
}>;


export type GetDispatchedRouteParcelCandidatesQuery = { __typename?: 'Query', dispatchedRouteParcelCandidates: Array<{ __typename?: 'RouteParcelAdjustmentCandidate', id: string, trackingNumber: string, recipientLabel: string, addressLine: string, longitude?: number | null, latitude?: number | null, status: ParcelStatus }> };
...
export type UpdateRouteAssignmentMutation = { __typename?: 'Mutation', updateRouteAssignment?: { __typename?: 'Route', id: string, zoneId: string, zoneName?: string | null, depotName?: string | null, depotAddressLine?: string | null, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, dispatchedAt?: string | null, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, estimatedStopCount: number, plannedDistanceMeters: number, plannedDurationSeconds: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null, latestParcelAdjustment?: { __typename?: 'RouteParcelAdjustmentAuditEntry', id: string, action: RouteParcelAdjustmentAction, parcelId: string, trackingNumber: string, reason: string, affectedStopSequence?: number | null, changedAt: string, changedBy?: string | null } | null } | null };
...
export type AddParcelToDispatchedRouteMutationVariables = Exact<{
  id: Scalars['UUID']['input'];
  input: AdjustRouteParcelInput;
}>;


export type AddParcelToDispatchedRouteMutation = { __typename?: 'Mutation', addParcelToDispatchedRoute?: { __typename?: 'Route', id: string, zoneId: string, zoneName?: string | null, depotName?: string | null, depotAddressLine?: string | null, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, dispatchedAt?: string | null, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, estimatedStopCount: number, plannedDistanceMeters: number, plannedDurationSeconds: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null, latestParcelAdjustment?: { __typename?: 'RouteParcelAdjustmentAuditEntry', id: string, action: RouteParcelAdjustmentAction, parcelId: string, trackingNumber: string, reason: string, affectedStopSequence?: number | null, changedAt: string, changedBy?: string | null } | null } | null };

export type RemoveParcelFromDispatchedRouteMutationVariables = Exact<{
  id: Scalars['UUID']['input'];
  input: AdjustRouteParcelInput;
}>;


export type RemoveParcelFromDispatchedRouteMutation = { __typename?: 'Mutation', removeParcelFromDispatchedRoute?: { __typename?: 'Route', id: string, zoneId: string, zoneName?: string | null, depotName?: string | null, depotAddressLine?: string | null, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, dispatchedAt?: string | null, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, estimatedStopCount: number, plannedDistanceMeters: number, plannedDurationSeconds: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null, latestParcelAdjustment?: { __typename?: 'RouteParcelAdjustmentAuditEntry', id: string, action: RouteParcelAdjustmentAction, parcelId: string, trackingNumber: string, reason: string, affectedStopSequence?: number | null, changedAt: string, changedBy?: string | null } | null } | null };
...
export const GetDepotParcelInventoryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetDepotParcelInventory"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"agingThresholdMinutes"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"depotParcelInventory"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"agingThresholdMinutes"},"value":{"kind":"Variable","name":{"kind":"Name","value":"agingThresholdMinutes"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"depotId"}},{"kind":"Field","name":{"kind":"Name","value":"depotName"}},{"kind":"Field","name":{"kind":"Name","value":"generatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"statusCounts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}},{"kind":"Field","name":{"kind":"Name","value":"zoneCounts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"zoneId"}},{"kind":"Field","name":{"kind":"Name","value":"zoneName"}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}},{"kind":"Field","name":{"kind":"Name","value":"agingAlert"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"thresholdMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]}}]} as unknown as DocumentNode<GetDepotParcelInventoryQuery, GetDepotParcelInventoryQueryVariables>;
export const GetDepotParcelInventoryParcelsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetDepotParcelInventoryParcels"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"agingThresholdMinutes"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ParcelStatus"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"zoneId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"agingOnly"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"depotParcelInventoryParcels"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"agingThresholdMinutes"},"value":{"kind":"Variable","name":{"kind":"Name","value":"agingThresholdMinutes"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}},{"kind":"Argument","name":{"kind":"Name","value":"zoneId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"zoneId"}}},{"kind":"Argument","name":{"kind":"Name","value":"agingOnly"},"value":{"kind":"Variable","name":{"kind":"Name","value":"agingOnly"}}},{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"totalCount"}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"hasPreviousPage"}},{"kind":"Field","name":{"kind":"Name","value":"startCursor"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}},{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"trackingNumber"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"zoneId"}},{"kind":"Field","name":{"kind":"Name","value":"zoneName"}},{"kind":"Field","name":{"kind":"Name","value":"ageMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"lastUpdatedAt"}}]}}]}}]}}]} as unknown as DocumentNode<GetDepotParcelInventoryParcelsQuery, GetDepotParcelInventoryParcelsQueryVariables>;
...
export const GetDispatchedRouteParcelCandidatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetDispatchedRouteParcelCandidates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"routeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dispatchedRouteParcelCandidates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"routeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"routeId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"trackingNumber"}},{"kind":"Field","name":{"kind":"Name","value":"recipientLabel"}},{"kind":"Field","name":{"kind":"Name","value":"addressLine"}},{"kind":"Field","name":{"kind":"Name","value":"longitude"}},{"kind":"Field","name":{"kind":"Name","value":"latitude"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<GetDispatchedRouteParcelCandidatesQuery, GetDispatchedRouteParcelCandidatesQueryVariables>;
...
export const AddParcelToDispatchedRouteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddParcelToDispatchedRoute"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AdjustRouteParcelInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addParcelToDispatchedRoute"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"RouteSummaryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"RouteSummaryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Route"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"zoneId"}},{"kind":"Field","name":{"kind":"Name","value":"zoneName"}},{"kind":"Field","name":{"kind":"Name","value":"depotName"}},{"kind":"Field","name":{"kind":"Name","value":"depotAddressLine"}},{"kind":"Field","name":{"kind":"Name","value":"vehicleId"}},{"kind":"Field","name":{"kind":"Name","value":"vehiclePlate"}},{"kind":"Field","name":{"kind":"Name","value":"driverId"}},{"kind":"Field","name":{"kind":"Name","value":"driverName"}},{"kind":"Field","name":{"kind":"Name","value":"stagingArea"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"dispatchedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"startMileage"}},{"kind":"Field","name":{"kind":"Name","value":"endMileage"}},{"kind":"Field","name":{"kind":"Name","value":"totalMileage"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"parcelCount"}},{"kind":"Field","name":{"kind":"Name","value":"parcelsDelivered"}},{"kind":"Field","name":{"kind":"Name","value":"estimatedStopCount"}},{"kind":"Field","name":{"kind":"Name","value":"plannedDistanceMeters"}},{"kind":"Field","name":{"kind":"Name","value":"plannedDurationSeconds"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"cancellationReason"}},{"kind":"Field","name":{"kind":"Name","value":"latestParcelAdjustment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"parcelId"}},{"kind":"Field","name":{"kind":"Name","value":"trackingNumber"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"affectedStopSequence"}},{"kind":"Field","name":{"kind":"Name","value":"changedAt"}},{"kind":"Field","name":{"kind":"Name","value":"changedBy"}}]}}]}}]} as unknown as DocumentNode<AddParcelToDispatchedRouteMutation, AddParcelToDispatchedRouteMutationVariables>;
export const RemoveParcelFromDispatchedRouteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveParcelFromDispatchedRoute"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AdjustRouteParcelInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeParcelFromDispatchedRoute"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"RouteSummaryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"RouteSummaryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Route"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"zoneId"}},{"kind":"Field","name":{"kind":"Name","value":"zoneName"}},{"kind":"Field","name":{"kind":"Name","value":"depotName"}},{"kind":"Field","name":{"kind":"Name","value":"depotAddressLine"}},{"kind":"Field","name":{"kind":"Name","value":"vehicleId"}},{"kind":"Field","name":{"kind":"Name","value":"vehiclePlate"}},{"kind":"Field","name":{"kind":"Name","value":"driverId"}},{"kind":"Field","name":{"kind":"Name","value":"driverName"}},{"kind":"Field","name":{"kind":"Name","value":"stagingArea"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"dispatchedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"startMileage"}},{"kind":"Field","name":{"kind":"Name","value":"endMileage"}},{"kind":"Field","name":{"kind":"Name","value":"totalMileage"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"parcelCount"}},{"kind":"Field","name":{"kind":"Name","value":"parcelsDelivered"}},{"kind":"Field","name":{"kind":"Name","value":"estimatedStopCount"}},{"kind":"Field","name":{"kind":"Name","value":"plannedDistanceMeters"}},{"kind":"Field","name":{"kind":"Name","value":"plannedDurationSeconds"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"cancellationReason"}},{"kind":"Field","name":{"kind":"Name","value":"latestParcelAdjustment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"parcelId"}},{"kind":"Field","name":{"kind":"Name","value":"trackingNumber"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"affectedStopSequence"}},{"kind":"Field","name":{"kind":"Name","value":"changedAt"}},{"kind":"Field","name":{"kind":"Name","value":"changedBy"}}]}}]}}]} as unknown as DocumentNode<RemoveParcelFromDispatchedRouteMutation, RemoveParcelFromDispatchedRouteMutationVariables>;
