        ...
        <ListDataTable minWidthClassName="min-w-[900px]">
          <thead>
            <tr className={listDataTableHeadRowClass}>
              ...
              <th className={cn(listDataTableThClass, "min-w-[200px]")}>Address</th>
          ...
          <tbody>
            {data.map((parcel) => (
              <tr key={parcel.id} className={listDataTableBodyRowClass}>
                ...
                <td className={cn(listDataTableTdClass, "max-w-[160px]")}>
                  <OverflowTooltipCell
                    fullText={parcel.recipientAddress?.contactName ?? "-"}
                  >
